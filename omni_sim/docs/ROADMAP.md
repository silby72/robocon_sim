...
> **この先を読む前に**: 本書は Phase A–C / P1–P4 の**経緯**の記録で、2026-09-13 で
> 止まっている。**現状（今のコードが何をするか・何をしないか）は
> [STATUS.md](STATUS.md) を見ること。** ROS連携・ブラウザUI・当たり判定・坂・
> 状態遷移・P5オドメトリ誤差・機体設定との配線は、すべてそちらにある。
